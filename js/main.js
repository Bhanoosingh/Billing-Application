...
.constant('DEFAULT_LOGO', 'images/WTBLogo.jpg')
...
.constant('DEFAULT_INVOICE', {
  ...
  company_info: {
    name: 'WebTechBros',
    web_link: 'https://www.facebook.com/webtechbros',
    address1: 'Prime Plaza',
    address2: 'Munshipulliya Lucknow',
    postal: '226001'
  },
  items:[
    { qty: 1, description: 'Product', cost: 0.00 }
  ]
})
